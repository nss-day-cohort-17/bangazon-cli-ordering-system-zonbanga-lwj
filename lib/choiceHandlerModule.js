...
const { getSessionInfo } = require('./sessionInfoModule')
const { listShoppingCart } = require('./listShoppingCart')
...
module.exports = (num) => {
  ...
  const choiceList = {
    ...
    '5': { "first": getSessionInfo, "second": listShoppingCart },
    '6': { "first": completeOrder, "second": addOrderToDb},
    '7': { "first": getPopularity, "second": listProductPopularity },
    '8': () => {
      return process.exit()
    }
  }
